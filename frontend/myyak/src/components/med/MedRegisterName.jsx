...
const MedRegisterNewName = () => {
  ...
  // 사용할 변수들
  // const [medBarcode, setMedBarcode] = useState(location.state.medBarcode)
  const medNum = location.state.medNum
  const slotNum = location.state.slotNum

  const medName = location.state.medName
  const medCompany = location.state.medCompany
  ...
  // useEffect(() => {
  //   // axios
  //   // 바코드 넘버 넘겨주면 약이름, 제조사 넘어오는 api 필요
...
export default MedRegisterNewName